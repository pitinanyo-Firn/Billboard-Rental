/* ============================================================
   PLAN B — BILLBOARD RENTAL HUB  |  js/ai.js
   ผู้ช่วย AI — ส่งคำถามไป backend (action: askAI)
   API key และข้อมูลค่าเช่าทั้งหมดอยู่ฝั่ง backend เท่านั้น
   ============================================================ */
...
const AI = {
  ...
  SUGGESTIONS: [
    'เดือนหน้าต้องเตรียมเงินจ่ายค่าเช่ารวมเท่าไหร่ มีรายการอะไรบ้าง',
    'รายการไหนเลยกำหนดจ่ายแต่ยังรอเบิกอยู่',
    'สรุปค่าเช่าต่อปีแยกตามประเภทสื่อ และ External / Inter-Co',
    'สัญญาไหนจะหมดอายุภายในสิ้นปีนี้'
  ],
