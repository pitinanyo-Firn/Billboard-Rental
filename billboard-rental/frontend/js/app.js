/* ============================================================
   PLAN B — BILLBOARD RENTAL HUB  |  js/app.js
...
const App = {
  ...
  /* ---------- โหลดข้อมูล ----------
     ...
     silent = โหลดเบื้องหลังจาก Sync — ไม่มี loader, คงแท็บ/ตัวกรองไว้ */
  ...
  async exportCSV() {
    ...
    a.download = `PlanB_BillboardRental_${new Date().toISOString().slice(0, 10)}.csv`;
