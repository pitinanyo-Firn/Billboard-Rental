/* ============================================================
   PLAN B — CONTRACT RENTAL HUB  |  js/sync.js
   ซิงค์สองทางกับ Google Sheet
     หน้าเว็บ → ชีต : บันทึกทันทีผ่าน API (notice.js)
...
const Sync = {
  ...
  isEditing() {
    ...
    return !!(a && a.matches && a.matches('.st-input, .st-select')) || Notice.saving > 0 || Editor.isOpen;
  },
